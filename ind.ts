...
// ─── More Actions menu builder ─────────────────────────────────────────────────
// Called each time the ⋮ button is clicked so menu items always reflect
// current store state (disabled flags, etc.)
            ...
            // ── REPOSITORIES ───────────────────────────────────────────────────────
            {
                ...
                actions: [

                    {
                        ...
                        onClick: () => console.log("Sort by Discovery Time TODO"), // TODO: Sort by Discovery Time
                    },
                    {
                        id: 'name',
                        label: 'Sort by Name',
                        // icon:    'icon',
                        // when:    'workspacePath != null',
                        onClick: () => console.log("Sort by Name"), // TODO: Sort by Name
                    },
                    {
                        id: 'path',
                        label: 'Sort by Path',
                        // icon:    'icon',
                        // when:    'workspacePath != null',
                        onClick: () => console.log("Sort by Path"), // TODO: Sort by Path
                    },
                ],
            },
